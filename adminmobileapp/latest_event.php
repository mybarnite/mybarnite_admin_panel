				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2 style="color:#fff;"><i class="icon-list"></i>Latest Event</h2>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                  ...
                                  <th style="color:#fff;" width="214">Event Images</th>
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from latest_event");
                            ...
                            <td> <a class="btn btn-info" href="update_latest_event.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="../adminimages/latestevent/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
