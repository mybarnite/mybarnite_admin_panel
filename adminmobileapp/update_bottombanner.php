...
$banner_query=mysql_query("select * from bottom_banner where id='".$_REQUEST['banner_id']."'");
 ...
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
	  $banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
       move_uploaded_file($_FILES["banner_image"]["tmp_name"],"../adminimages/banner/".$banner_image);
	 ...
	 $succ = mysql_query("update bottom_banner set  banner_image='".$banner_image."',`heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	 }
		if($_FILES['banner_image']['name']==''){
	 ...
	 $succ1 = mysql_query("update bottom_banner set  `heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']=" Updated";
		   ...
		   ?>
		  <script>window.location.href="bottombanner.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Banner</h2>
						<div align="right">
							<a href="bottombanner.php?t=true" class="btn btn-setting btn-round">Back To Banner</a>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
					 ...
					 <tr >
						...
						<td><img width="300" height="300" src="../adminimages/banner/<?=$fetch_banner['banner_image'];?>" ></img></td>
