<? include("header.php");
  ...
  $succ_del=mysql_query("delete from tbl_clasified where id='".$id."'");
   ...
   if($succ_del)
  {
  $_SESSION['msg']="Selected Services is successfully deleted";
  }
  else
  {
  $_SESSION['msg']="Services is not successfully deleted";
  }
  ?>
	   <script>window.location.href="manage_services.php?cat_id=<?=$_REQUEST['cat_id'];?>&msg=<?=$_SESSION['msg'];?>";</script>
	  <?
  }
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Services Management</h2>
						<div align="right">
                        <a href="add_new_services.php?cat_id=<?=$_REQUEST['cat_id'];?>" class="btn btn-setting btn-round">Add New</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <? 
						  $i=0;
						  $sel_cat_query= mysql_query("select * from tbl_elearning_cpd as c,tbl_clasified as sc where c.id=sc.category_id and sc.category_id='".$_REQUEST['cat_id']."'");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_services.php?cat_id=<?=$_REQUEST['cat_id'];?>&id=<?=$fetch_category['id'];?>">
