<? include("header.php");
  ...
  foreach($chk as $id)
  {
	  $tmp_img_qury= mysql_query("select * from  tbl_professional_courses where id='".$id."'");
	$fetch_img_name=mysql_fetch_array($tmp_img_qury);
	$file_to_delete="product_images/".$fetch_img_name['category_image'];
	unlink($file_to_delete);
  $succ_del=mysql_query("delete from  tbl_professional_courses where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_professional_courses set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_professional_courses set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
					<a href="add_new_professional.php" class="btn btn-setting btn-round">Add New Category</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                         ...
                         <!--<th width="167">Category Image</th>-->
						  ...
						  <tbody>
                          <? $sel_deptmet_query= mysql_query("select * from  tbl_professional_courses");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_professional.php?cat_id=<?=$fetch_department['id']; ?>">
                          ...
                          -->     <td align="center">
                                  <a class="btn btn-info" href="manage_professionalsubcategory.php?cat_id=<?=$fetch_department['id']; ?>">Add/View Subcategory</a>
