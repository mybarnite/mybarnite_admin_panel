...
$banner_query=mysql_query("select * FROM about_us_note where id='".$_REQUEST['banner_id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 $succ = mysql_query("update about_us_note set  `heading`='".$banner_heading."' , `message`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']="Message is Updated";
		   ...
		   ?>
		  <script>window.location.href="about_us_note.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
							<a href="update_about_us_note.php?t=true" class="btn btn-setting btn-round">Back To About Us Note</a>
