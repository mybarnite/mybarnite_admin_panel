			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2 style="color:#fff;"><i class="icon-edit"></i>&nbsp;Change Admin Password</h2>
						<div class="box-icon">
							&nbsp;
						</div>
					</div>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                        ...
                        <td>&nbsp;</td>
						 ...
						 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">User Login Id*</label></td>
                        <td><input type="text" class="span6 typeahead"  name="admin_login_id" id="admin_login_id"  size="40" /></td>
                         </tr>
                        <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">New Password*</label></td>
                        <td><input type="password" class="span6 typeahead"  name="new_pass" id="new_pass"  size="40" /></td>
                         </tr>
                          <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Confirm Password*</label></td>
