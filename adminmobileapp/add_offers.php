<? include("header.php");
 ...
 {
	 echo $page_heading=addslashes(trim($_REQUEST['page_heading']));
	 echo $page_content=addslashes(trim($_REQUEST['page_content']));
      $image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['image']['name']);
       move_uploaded_file($_FILES["image"]["tmp_name"],"../images/".$image);
     
   
	  
       $succ= mysql_query("insert into tbl_offers set news_heading='".$page_heading."',news_description='".$page_content."', image='".$image."'");	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Add New Offer</h2>
					  <div align="right">
