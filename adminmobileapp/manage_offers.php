<? include("header.php");
  ...
  foreach($chk as $id)
  {
  $succ_del=mysql_query("delete from tbl_offers where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_offers set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_offers set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Special Offers Management</h2>
					  <div align="right">
                        <a href="add_offers.php" class="btn btn-setting btn-round">Add New</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_page_query= mysql_query("select * from tbl_offers");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_offers.php?page_id=<?=$fetch_content['id']; ?>">
