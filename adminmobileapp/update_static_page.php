...
$page_query=mysql_query("select * from tbl_static_page where id='".$_REQUEST['page_id']."'");
 ...
 if(isset($_REQUEST['add_new_page']))
 {
	 ...
	 $page_content = addslashes(trim($_REQUEST['page_content']));
       ...
       move_uploaded_file($_FILES["image"]["tmp_name"],"product_images/".$image);
	    $succ= mysql_query("update tbl_static_page set image='".$image."' where id='".$_REQUEST['page_id']."'");	 
	 
		}
       $succ= mysql_query("update tbl_static_page set page_content='".$page_content."' where id='".$_REQUEST['page_id']."'");	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
                       	<a href="manage_static_page.php" class="btn btn-setting btn-round">Back To Static Page List</a>
						</div>
					</div>
