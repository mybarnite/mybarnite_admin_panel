				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2 style="color:#fff;"><i class="icon-list"></i>Download Mobile App</h2>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                   ...
                                   <th width="24" style="color:#fff;">Edit</th>
                                  
                                  <th width="214" style="color:#fff;">Mobile Images</th>
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from mobile_app_message");
                            ...
                            <td> <a class="btn btn-info" href="update_downloadmobileapp.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="../adminimages/download_mobile_app/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
