...
$banner_query=mysql_query("select * from main_content where id='".$_REQUEST['banner_id']."'");
 ...
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
	  $banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
       move_uploaded_file($_FILES["banner_image"]["tmp_name"],"images/main_content/".$banner_image);
	   $banner_heading=mysql_real_escape_string(trim(addslashes($_REQUEST['banner_heading'])));
	   
	   
	 $succ = mysql_query("update main_content set  banner_image='".$banner_image."',`heading`='".$banner_heading."'  where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	 }
		if($_FILES['banner_image']['name']==''){
	 ...
	 $succ1 = mysql_query("update main_content set  `heading`='".$banner_heading."'  where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']="Image is Updated";
		   ...
		   ?>
		  <script>window.location.href="main_content.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
				...
				<div class="box span12">
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<td><img width="300" height="300" src="images/main_content/<?=$fetch_banner['banner_image'];?>" ></img></td>
