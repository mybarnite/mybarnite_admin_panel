...
$banner_query=mysql_query("select * FROM upcoming_event where id='".$_REQUEST['banner_id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 $succ = mysql_query("update upcoming_event set  `heading`='".$banner_heading."' , `message`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2 style="color:#fff;"><i class="icon-edit"></i>Update Upcoming Event</h2>
						<div align="right">
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<table align="center" width="80%" >
						 ...
						 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Message Heading*</label></td>
					 ...
					 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Message Description*</label></td>
