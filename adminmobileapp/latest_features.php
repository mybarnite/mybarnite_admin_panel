                 ...
                 <script src="js/functionsforcheckall.js"></script>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from slider_tbl");
                            ...
                            <td> <a class="btn btn-info" href="update_leatestfeatures.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="images/sliderimages/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
