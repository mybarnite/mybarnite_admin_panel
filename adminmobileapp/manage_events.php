<? include("header.php");
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_events set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_events set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  ...
					  <div align="right">
                        <a href="add_events.php" class="btn btn-setting btn-round">Add New</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_page_query= mysql_query("select * from tbl_events");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_events.php?page_id=<?=$fetch_content['id']; ?>">
