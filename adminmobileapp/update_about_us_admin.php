...
$banner_query=mysql_query("select * from about_us_admin where id='".$_REQUEST['banner_id']."'");
 ...
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
	  $banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
       move_uploaded_file($_FILES["banner_image"]["tmp_name"],"images/aboutus/".$banner_image);
	 ...
	 $succ = mysql_query("update about_us_admin set  banner_image='".$banner_image."',`heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	 }
		if($_FILES['banner_image']['name']==''){
	 ...
	 $succ1 = mysql_query("update about_us_admin set  `heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']="Image is Updated";
		   ...
		   ?>
		  <script>window.location.href="about_us_admin.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
							<a href="about_us_admin.php?t=true" class="btn btn-setting btn-round">Back To About Us</a>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<table align="center" width="80%" >
						 ...
						 <tr >
                        <td ><label class="control-label" for="typeahead">About Us Image Heading*</label></td>
					 ...
					 <tr >
                        <td ><label class="control-label" for="typeahead">About Us Image Description*</label></td>
						...
						<td><img width="300" height="300" src="images/aboutus/<?=$fetch_banner['banner_image'];?>" ></img></td>
