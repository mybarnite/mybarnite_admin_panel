 ...
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
	  $banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
	   ...
	   $banner_heading1=mysql_real_escape_string(trim(addslashes($_REQUEST['banner_heading1'])));
	   $banner_desc1=mysql_real_escape_string(trim(addslashes($_REQUEST['banner_desc1'])));
	   
	 $succ = mysql_query("update special_event set  banner_image='".$banner_image."',`heading`='".$banner_heading."' , `desc`='".$banner_desc."',heading2`='".$banner_heading1."' , `desc2`='".$banner_desc1."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	 }
		if($_FILES['banner_image']['name']==''){
	 ...
	 $succ1 = mysql_query("update special_event set `heading`='".$banner_heading."' , `desc`='".$banner_desc."',heading2`='".$banner_heading1."' , `desc2`='".$banner_desc1."' ")or die(mysql_error());	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2 style="color:#fff;"><i class="icon-edit"></i>Update Special Event</h2>
						<div align="right">
							<a href="slider.php?t=true" class="btn btn-setting btn-round">Back To Special Event</a>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<table align="center" width="80%" >
						 ...
						 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead"> Heading 1*</label></td>
					 ...
					 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Description 1*</label></td>
                        <td><textarea  class="span6 typeahead"  name="banner_desc" id="banner_image"  size="40" ><?php echo $fetch_banner['desc']; ?></textarea></td>
                         </tr>
						 
						 
						  <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead"> Heading 2*</label></td>
                        <td><input type="text" class="span6 typeahead"  name="banner_heading1" id="banner_image" value="<?php echo $fetch_banner['heading2']; ?>"  size="40" /></td>
                         </tr>
					 
					 
					 
					 <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Description 2*</label></td>
                        <td><textarea  class="span6 typeahead"  name="banner_desc1" id="banner_image"  size="40" ><?php echo $fetch_banner['desc2']; ?></textarea></td>
                         </tr>
                        ...
                        <tr >
                        <td style="color:#fff;"><label class="control-label" for="typeahead">Slider  Image*</label></td>
