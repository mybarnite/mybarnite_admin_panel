                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                   <th width="20">Edit</th>
                                   <th width="24">Gallery  Image</th>
                                  
                                  <th width="214">Heading 1</th>
								<th>Meassage 1</th>
								<th width="214">Heading 2</th>
								<th>Meassage 2</th>
								  
							  </tr>
						  </thead>   
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from home_content_1");
                            ...
                            <td> <a class="btn btn-info" href="update_home_content_1.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="images/maincontent/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
								<td class="center"><?=$fetch_banner['heading'];?></td>
								<td class="center"><?=$fetch_banner['message'];?></td>
                                <td class="center"><?=$fetch_banner['heading1'];?></td>
								<td class="center"><?=$fetch_banner['message1'];?></td>
                      ...
                      <tr>
								...
								<td class="center">&nbsp;</td>
								<td  align="right">
                                	<?php /*?><input type="submit" name="active" value="Acitve" class="input btn btn-danger" />
                              <input type="submit" name="inactive" value="Inactive" class="input btn btn-danger" />
                            <input type="submit" name="delete" value="Delete" class="input btn btn-danger" onclick="return confirmSubmit()"/><?php */?>
						</td>
                      </table> 
                      </form>          
					</div>
