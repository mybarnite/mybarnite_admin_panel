...
$query = "SELECT e.*, b.Business_Name from tbl_events as e join bars_list as b on e.bar_id = b.id where eventtype = 'Latest'" ;
$countSql = "SELECT COUNT(*) AS count from tbl_events as e join bars_list as b on e.bar_id = b.id where eventtype = 'Latest'";
