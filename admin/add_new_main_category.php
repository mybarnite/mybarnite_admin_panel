<? include("header.php");
...

 {
   ...
   $query= mysql_query("select * from tbl_elearning_cpd where category_name='".$category_name."'");
     ...
     $_SESSION['msg']="Category is Already Exist";	
	   ...
	   ?>
		  ...
		  <script>window.location.href="add_new_main_category.php?msg=<?=$_SESSION['msg'];?>"</script>
...

	 {
	  ...
	  $category_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['category_image']['name']);
       ...
       $succ= mysql_query("insert into tbl_elearning_cpd set category_name='".$category_name."',url='".$url."',category_descr='".$category_descr."',category_image='".$category_image."',meta_title='".$meta_title."',meta_keywords='".$meta_keywords."',meta_descr='".$meta_descr."'");	 
