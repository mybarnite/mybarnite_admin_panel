<? include("header.php");
  ...
  foreach($chk as $id)
  {
  $succ_del=mysql_query("delete from  tbl_contractor_register where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  ?>
	   <script>window.location.href="manage_contractoregister.php?msg=<?=$_SESSION['msg'];?>&t=true";</script>
	  <?
  }
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_contractor_register set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_contractor_register set status='Inactive' where id='".$id."'");
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                  ...
                                  <th width="93"> Organisation</th>
                                  <th width="93"> Designation</th>
                                  <th width="93">Mobile</th>
                                  <th width="93">Subject</th>
						  ...
						  <tbody>
                          <? $sel_page_query= mysql_query("select * from  tbl_contractor_register");
						  ...
						  ?>
                            ...
                            <td class="center"><?=$fetch_content['user_name'];?></td>
                            <td class="center"><?=$fetch_content['user_email'];?></td>
                            <td class="center"><?=$fetch_content['user_organisation'];?></td>
                            <td class="center"><?=$fetch_content['user_designation'];?></td>
                            <td class="center"><?=$fetch_content['user_mobile'];?></td>
                            <td class="center"><?=$fetch_content['user_subject'];?></td>
                            <td class="center"><?=$fetch_content['user_message'];?></td>
