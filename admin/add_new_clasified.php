   ...
   $query= mysql_query("select * from tbl_subcategory where subcategory_name='".$subcategory_name."' and subcategory_id='".$_REQUEST['sub_cat']."'");
	 ...
	 else
	 {
	  ...
	  $subcat_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['subcat_image']['name']);
       ...
       $succ= mysql_query("insert into tbl_clasified set subcat_name='".$subcategory_name."',subcat_image='".$subcat_image."',url='".$url."', video='".$video."',category_descr='".$category_descr."',subcategory_id = '".$_REQUEST['sub_cat']."',meta_title='".$meta_title."',meta_keywords='".$meta_keywords."',meta_descr='".$meta_descr."'");	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
                        <a href="manage_clasified.php?cat_id=<?=$_REQUEST['cat_id'];?>&subcat_id=<?=$_REQUEST['sub_cat'];?>" class="btn btn-setting btn-round">Back</a>
