...
$banner_query=mysql_query("select * from banner_content where id='".$_REQUEST['banner_id']."'");
 ...
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
	  $banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
       move_uploaded_file($_FILES["banner_image"]["tmp_name"],"images/bannerimage/".$banner_image);
	 ...
	 $succ = mysql_query("update banner_content set  banner_image='".$banner_image."',`heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	 }
		if($_FILES['banner_image']['name']==''){
	 ...
	 $succ1 = mysql_query("update banner_content set  `heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']="Image is Updated";
		   ...
		   ?>
		  <script>window.location.href="banner_content.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
				...
				<div class="box span12">
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
					 ...
					 <tr >
						...
						<td><img width="300" height="300" src="images/bannerimage/<?=$fetch_banner['banner_image'];?>" ></img></td>
