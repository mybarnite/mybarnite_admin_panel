...
$banner_query=mysql_query("select * from member_register where id='".$_REQUEST['banner_id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 $succ1 = mysql_query("update member_register set  `name`='".$name."',`email`='".$email."',`contact`='".$contect."'  where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
							<a href="member_list.php?t=true" class="btn btn-setting btn-round">Back To Member List</a>
