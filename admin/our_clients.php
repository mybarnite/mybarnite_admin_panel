<? include("header.php");
  ...
  foreach($chk as $id)
  {
	  $tmp_img_qury= mysql_query("select * from our_client where id='".$id."'");
	$fetch_img_name=mysql_fetch_array($tmp_img_qury);
	$file_to_delete="product_images/".$fetch_img_name['banner_image'];
	unlink($file_to_delete);
  $succ_del=mysql_query("delete from our_client where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  ?>
	   <script>window.location.href="our_clients.php?msg=<?=$_SESSION['msg'];?>&t=true";</script>
	  <?
  }
  ...
  foreach($chk as $id)
  {
  mysql_query("update our_client set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update our_client set status='Inactive' where id='".$id."'");
				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i> Our Client</h2>
						...
						?>
						<div align="right">
							<a href="add_new_ourclient.php?t=true" class="btn btn-setting btn-round">Add New Image</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from our_client");
                            ...
                            <td> <a class="btn btn-info" href="update_ourclient.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="images/ourclient/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
