				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Welcome Cufflink</h2>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from main_heading");
							...
							<td></td>
                            <td> <a class="btn btn-info" href="update_mainheading.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
