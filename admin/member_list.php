<?php include("header.php");
  ...
  $succ_del=mysql_query("delete from member_register where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  ?>
	   <script>window.location.href="member_list.php?msg=<?=$_SESSION['msg'];?>&t=true";</script>
	  <?php
  }
  ...
  foreach($chk as $id)
  {
  mysql_query("update member_register set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update member_register set status='Suspended' where id='".$id."'");
				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i> Member List</h2>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <?php $sel_banner_query= mysql_query("select * from member_register");
                            ...
                            <td> <a class="btn btn-info" href="update_member_list.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
