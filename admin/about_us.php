						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                ...
                                <th>Detail Main Objective</th>
								<th>Company History</th>
                                <th>Detail Company History</th>
                               
								  
							  </tr>
						  </thead>   
						  <tbody>
                          <?php $sel_banner_query= mysql_query("select * from about_us");
                           ...
                           <?php /*?> <td><input type="checkbox" name="chk[]" value="<?=$fetch_banner['id']; ?>" /></td><?php */?>
                            <td> <a class="btn btn-info" href="update_about_us.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a>
								<td class="center"><?=$fetch_banner['main_objectibe'];?></td>
								<td class="center"><?=$fetch_banner['detail_main_objective'];?></td>
                                <td class="center"><?=$fetch_banner['company_history'];?></td>
								<td class="center"><?=$fetch_banner['detail_company_history'];?></td>
