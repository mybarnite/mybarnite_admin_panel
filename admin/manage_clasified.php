<? include("header.php");
  ...
  foreach($chk as $id)
  {
  $succ_del=mysql_query("delete from  tbl_clasified where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  ?>
	   <script>window.location.href="manage_clasified.php?cat_id=<?=$_REQUEST['cat_id'];?>&subcat_id=<?=$_REQUEST['subcat_id'];?>&msg=<?=$_SESSION['msg'];?>";</script>
	  <?
  }
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_clasified set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_clasified set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Events Management</h2>
						<div align="right">
                        <a href="add_new_clasified.php?cat_id=<?=$_REQUEST['cat_id'];?>&sub_cat=<?=$_REQUEST['subcat_id'];?>" class="btn btn-setting btn-round">Add New Services</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <? 
						  $i=0;
						  $sel_cat_query= mysql_query("select * from tbl_subcategory as c,tbl_clasified as sc where c.id=sc.subcategory_id and sc.subcategory_id='".$_REQUEST['subcat_id']."'");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_clasified.php?cat_id=<?=$_REQUEST['cat_id'];?>&subcat_id=<?=$_REQUEST['subcat_id']; ?>&id=<?=$fetch_category['id']; ?>">
