...
$banner_query=mysql_query("select * from slider_images_tb where id='".$_REQUEST['banner_id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 if($_FILES['banner_image']['name']!='')
	 {
		...
		{
			$_SESSION['msg']="Invalid file. (png,jpg files are allowed.)";
		}
		else
		{
			$banner_image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['banner_image']['name']);
			move_uploaded_file($_FILES["banner_image"]["tmp_name"],"../adminimages/slider/".$banner_image);
			...
			$succ = mysql_query("update slider_images_tb set  banner_image='".$banner_image."',`heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 	
		}		
	   ...
	   $banner_desc=mysql_real_escape_string(trim(addslashes($_REQUEST['banner_desc'])));
		...
		$succ1 = mysql_query("update slider_images_tb set  `heading`='".$banner_heading."' , `desc`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
	...
	else
	{
		 if($succ1){
		   ...
		   ?>
		  <script>window.location.href="slider.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
							<a href="slider.php?t=true" class="btn btn-setting btn-round">Back To Slider Images</a>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<table align="center" width="80%" >
						 ...
						 <tr >
                        <td ><label class="control-label" for="typeahead">Slider Image Heading*</label></td>
					 ...
					 <tr >
                        <td ><label class="control-label" for="typeahead">Slider Image Description*</label></td>
						...
						<td><img width="300" height="300" src="../adminimages/slider/<?=$fetch_banner['banner_image'];?>" ></img></td>
