 ...
 if(isset($_REQUEST['add_new_page']))
 {
	 ...
	 echo $page_content=addslashes(trim($_REQUEST['page_content']));
      $image = md5(uniqid(rand(), true)).'.'.file_ext($_FILES['image']['name']);
       ...
       $succ= mysql_query("insert into tbl_tours set news_heading='".$page_heading."',news_description='".$page_content."', image='".$image."'");	 
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Add New tbl_tours Tab</h2>
					  <div align="right">
