...
$banner_query=mysql_query("select * from tbl_pdf where id='".$_REQUEST['id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	...
	$succ= mysql_query("update tbl_pdf set pdf = '".$banner_image."' where id='".$_REQUEST['id']."'");	 
	 }
	       ...
	       if($succ)
		 {
		   ...
		   $_SESSION['msg']="Pdf is Successfully Updated";	
		   }
		   else
		 {
		   $_SESSION['msg']="Pdf is Not Updated";	
		   }
		   ?>
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
							<a href="manage_pdf.php" class="btn btn-setting btn-round">Back To PDF List</a>
...
{Eg: http://example.com} </td>
                        ...
                        <tr >
                        <td align="center"><label class="control-label" for="typeahead">PDF*</label></td>
