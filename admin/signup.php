...
<?php
		if(isset($_POST['register']))
		{
			...
			if($result > 0)
			{
				echo "<script>window.location.href='signup.php?duplicateemailstatus=Email Already Exists '</script>";
			}
			
			$query = mysql_query(" INSERT INTO user_register VALUES('','".$name."','".$email."','".$password."','".$number."')  ");
			
			echo "<script>window.location.href='signin.php?registerstatus=Registration Successfully Login Now'</script>";
		}
?>
    ...
    <div class="row clearfix ">
		...
		<div class="span6">
			...
			<?php } ?>
						...
						<br>
      					<input style="float:right;" type="submit" name="register" class="btn submit btn-primary " value="SIGN UP">
