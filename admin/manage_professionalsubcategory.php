<? include("header.php");
  ...
  foreach($chk as $id)
  {
  $succ_del=mysql_query("delete from tbl_professionalsubcategory where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  ?>
	   <script>window.location.href="manage_professionalsubcategory.php?cat_id=<?=$_REQUEST['cat_id'];?>&msg=<?=$_SESSION['msg'];?>";</script>
	  <?
  }
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_professionalsubcategory set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update  tbl_professionalsubcategory set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div align="right">
                        <a href="add_new_profsubcategory.php?cat_id=<?=$_REQUEST['cat_id'];?>" class="btn btn-setting btn-round">Add New</a>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <? 
						  $i=0;
						  $sel_cat_query= mysql_query("select * from tbl_professional_courses as c,tbl_professionalsubcategory as sc where c.id=sc.category_id and sc.category_id='".$_REQUEST['cat_id']."'");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_profsubcategory.php?cat_id=<?=$_REQUEST['cat_id'];?>&subcat_id=<?=$fetch_category['id']; ?>">
							<i class="icon-pencil" title="Edit"></i></a></td>
                               ...
                               <!-- <?php
                                ...
                                <td align="center">
                                <p><a class="btn btn-info" href="manage_courses.php?cat_id=<?=$_REQUEST['cat_id'];?>&subcat_id=<?=$fetch_category['id']; ?>">Add /View Services</a></p>
