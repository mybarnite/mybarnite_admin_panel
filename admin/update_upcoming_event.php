...
$banner_query=mysql_query("select * FROM tbl_events where id='".$_REQUEST['banner_id']."'");
$fetch_banner=mysql_fetch_array($banner_query);
 if(isset($_REQUEST['add_new_banner']))
 {
	 ...
	 $succ = mysql_query("update tbl_events set  `event_name`='".$banner_heading."' , `event_description`='".$banner_desc."' where id='".$_REQUEST['banner_id']."'")or die(mysql_error());	 
		 ...
		 $_SESSION['msg']="Message is Updated";
		   ...
		   ?>
		  <script>window.location.href="upcoming_event.php?msg=<?=$_SESSION['msg'];?>&t=true"</script>
		   <?php
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Update Upcoming Event</h2>
						<div align="right">
							<a href="upcoming_event.php?t=true" class="btn btn-setting btn-round">Back To Upcoming Event</a>
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
                        ...
                        <td><input type="text" class="span6 typeahead"  name="banner_heading" id="banner_image" value="<?php echo $fetch_banner['event_name']; ?>"  size="40" /></td>
                         </tr>
					 ...
					 <tr >
                        ...
                        <td><textarea  class="span6 typeahead"  name="banner_desc" id="banner_image"  size="40" ><?php echo $fetch_banner['event_description']; ?></textarea></td>
                         </tr>
