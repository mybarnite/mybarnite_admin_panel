				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Slider Images</h2>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <?php $sel_banner_query= mysql_query("select * from slider_images_tb");
						     while($fetch_banner=mysql_fetch_array($sel_banner_query))
							 {
							
									  ?>
							<tr>
                            <td><input type="checkbox" name="chk[]" value="<?php echo $fetch_banner['id']; ?>" /></td>
                            <td> <a class="btn btn-info" href="update_slider.php?banner_id=<?php echo $fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="../adminimages/slider/<?php echo $fetch_banner['banner_image'];?>" width="100" height="100" /></td>
