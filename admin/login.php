...
if(isset($_REQUEST['login']))
{
		...
		{ */
				...
				$user_chk_query="select * from tbl_admin where admin_login_id='".$username."' and admin_password='".$password."' and admin_status='Active'";
				...
				if($row==1)
				{
					...
					if($r_id==4)
					{
						...
						$_SESSION['USER_TYPE']=$fetch_user['admin_type']; 
						$_SESSION['SUBUSER_ID']= $fetch_user['id']; 
		...
		{
			$_SESSION['msg']='Invalid Login. Please contact to administrator!!';
		} */	
}
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2> Admin Panel For  <sup></sup>Web Site</h2>
				</div><!--/span-->
			</div><!--/row-->
			
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div <?php if($_SESSION['msg']!=''){ ?>class="alert alert-info" <?php }?>>
