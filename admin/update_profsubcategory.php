...
$sel_subcategory=mysql_query("select * from tbl_professionalsubcategory where id='".$_REQUEST['subcat_id']."'");
...

 {
	...
	$subcategory_name=$_REQUEST['subcategory_name'];
	 ...
	 $meta_descr=trim($_REQUEST['meta_descr']);
	  ...
	  $succ= mysql_query("update tbl_professionalsubcategory set subcat_image='".$subcat_image."' where id='".$_REQUEST['subcat_id']."'");	 
 
	 }
       $succ= mysql_query("update tbl_professionalsubcategory set subcategory_name='".$subcategory_name."',meta_title='".$meta_title."',meta_keywords='".$meta_keywords."',meta_descr='".$meta_descr."'  where id='".$_REQUEST['subcat_id']."'");	 
