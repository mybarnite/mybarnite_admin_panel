				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Slider Images 2</h2>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
                                  ...
                                  <th width="214">Slider 2 Images</th>
								<th>Club Name</th>
								<th>Timing</th>
						  ...
						  <tbody>
                          <?php $sel_banner_query= mysql_query("select * from slider_images_2");
                            ...
                            <td> <a class="btn btn-info" href="update_slider2.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a></td>
                         		<td class="center"><img src="../adminimages/slider2/<?=$fetch_banner['banner_image'];?>" width="100" height="100" /></td>
