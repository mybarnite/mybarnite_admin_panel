...
if(isset($_REQUEST['delete']))
	{
		...
		?>
		   <script>window.location.href="upcomingevents.php?msg=<?=$_SESSION['msg'];?>&t=true";</script>
		<?php
	}
					...
					<div class="row-fluid sortable">		
						<div class="box span12">
								...
								<div class="box-header well" data-original-title>
										<h2><i class="icon-list"></i> Manage Upcoming Events</h2>
												...
												<thead>
													...
													<tr>
														...
														<th>
															...
															<input type="button" id="reset" class="btn btn-danger"  value="Reset" name="Reset" onClick="location.href='upcomingevents.php'">
														</th>
													</tr>
												</thead>  
