				...
				<div class="box span12">
                 <script src="js/functionsforcheckall.js"></script>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>About Us Note</h2>
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_banner_query= mysql_query("select * from our_product");
							...
							<td></td>
                            <td> <a class="btn btn-info" href="update_our_product.php?banner_id=<?=$fetch_banner['id']; ?>&t=true">
							<i class="icon-pencil" title="Edit"></i></a>
								<td class="center"><?=$fetch_banner['caption'];?></td>
								<td class="center"><?=$fetch_banner['description'];?></td>
                                <td class="center"><?=$fetch_banner['percentage'];?></td>
