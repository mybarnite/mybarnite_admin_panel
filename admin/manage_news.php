<? include("header.php");
  ...
  foreach($chk as $id)
  {
  $succ_del=mysql_query("delete from tbl_news where id='".$id."'");
  }
   if($succ_del)
  {
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_news set status='Active' where id='".$id."'");
  ...
  foreach($chk as $id)
  {
  mysql_query("update tbl_news set status='Inactive' where id='".$id."'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Home Tabs Management</h2>
					  <div align="right">
                    ...
                    <form action="" method="post" onSubmit="return validate()">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <? $sel_page_query= mysql_query("select * from tbl_news order by id desc");
						  ...
						  ?>
                            ...
                            <td> <a class="btn btn-info" href="update_new.php?page_id=<?=$fetch_content['id']; ?>">
							<i class="icon-pencil" title="Edit"></i></a></td>
                            
							<!--td class="center"><img src="../images/icons/<?php //$fetch_content['image'];?>" /> </img></td-->
