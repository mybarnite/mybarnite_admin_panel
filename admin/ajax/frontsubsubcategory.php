...
?>
       ...
       <table width="98%" border="0" cellspacing="0" cellpadding="0">
                      <?php $exe_prdq= mysql_query("select * from tbl_product where category_id='".$category_id."' and subcategory_id='".$fetch_subcat['id']."' and price between '$min' and '$max' and status='Active'");
