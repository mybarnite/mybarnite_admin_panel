			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Latest Event</h2>
						<div align="right">
                    ...
                    <tr><td align="center" style="color:#F00;"><strong><? echo $_REQUEST['msg'];?></strong></td></tr>
                     <tr><td align="center" style="color:#F00;">&nbsp;</td></tr>
						...
						<table align="center" width="80%" >
						 ...
						 <tr >
                        <td ><label class="control-label" for="typeahead">Event Heading*</label></td>
					 ...
					 <tr >
                        <td ><label class="control-label" for="typeahead">Event Description*</label></td>
                        ...
                        <tr >
                        <td ><label class="control-label" for="typeahead">Event Image*</label></td>
