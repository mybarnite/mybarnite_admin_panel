...
if(isset($_REQUEST['delete']))
	{
		...
		?>
		   <script>window.location.href="latestevents.php?msg=<?=$_SESSION['msg'];?>&t=true";</script>
		<?php
	}
					...
					<div class="row-fluid sortable">		
						<div class="box span12">
								...
								<div class="box-header well" data-original-title>
										<h2><i class="icon-list"></i> Manage Latest Events</h2>
											...
											<table class="table table-striped table-bordered bootstrap-datatable datatable">
												<thead>
													...
													<tr>
														...
														<th><input type="text" name="BarName" id="EventName" class="form-group" style="width:150px;"/></th>
														<th>
	 ...
	 $.ajax(
      {
        ...
        success: function(response){
			alert(response);
			window.location = "latestevents.php";
        }
