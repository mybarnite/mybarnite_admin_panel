...
<?php
		if(isset($_POST['editprofile']))
		{
			...
			$query = mysql_query(" UPDATE user_register set name='".$name."',email='".$email."',password='".$password."',contact='".$number."' ") or die(mysql_error());
			
			echo "<script>window.location.href='profile.php?editstatus=Successfully Edit Profile'</script>";
		}
?>
